...
const Breadcrumb = React.forwardRef(({ className, ...props }, ref) => (
  <nav ref={ref} aria-label="breadcrumb" className={cn("flex w-full overflow-hidden", className)} {...props} />
))
...
const BreadcrumbPage = React.forwardRef(({ className, ...props }, ref) => (
  <span ref={ref} role="doc-pagebreak" aria-current="page" aria-label="breadcrumb" className={cn("font-normal text-foreground", className)} {...props} />
))
